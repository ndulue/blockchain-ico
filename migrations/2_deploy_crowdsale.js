...
module.exports = async function (deployer, network, accounts) {
  ...
  const latestTime = (new Date).getTime;
    ...
    const  _cap             = latestTime + duration.minutes(1);
    const  _openingTime     = _openingTime + duration.weeks(1);
    const  _closingTime     = ether(100);
  ...
  await deployer.deploy(DappTokenCrowdsale,
      _rate,
      _wallet,
      _token.address,
      _cap,
